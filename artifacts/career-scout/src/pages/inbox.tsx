...
function FilterEffectivenessPanel() {
  ...
  return (
    <div className="pt-4 border-t-2 border-border space-y-4">
      ...
      {data && (
        <div className="space-y-5">
          {/* Dashboard visibility breakdown — not date-filtered (live DB snapshot) */}
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide mb-2">Dashboard visibility (live)</p>
